...
//print_r($_SESSION['pid'])=$pdtid;exit;
	?>
				...
				<tr>
					...
					<p>Delete</p><input type="checkbox" name="remove_code[]" value="<?php echo htmlentities($row['id']);?>" /></td>
					<td class="cart-image">
				...
				<tr>
					<td>
						<div class="cart-checkout-btn pull-right">
							<button type="submit" name="ordersubmit" class="btn btn-primary ordersubmit">PROCCED TO CHEKOUT</button>
...
<?php include('includes/footer.php');?>
	...
	<script>
		...
		$('.ordersubmit').click(function(){
			 totalprice = '<?php echo $_SESSION['tp']="$totalprice". ".00"; ?>';
             if(totalprice <200){
				alert("price should be greater than 200") 
			 }
			});
